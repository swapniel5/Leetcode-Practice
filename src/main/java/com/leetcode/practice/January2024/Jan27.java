...
*  appears only once. The relative order of the elements should be kept the same. Then return the number of
...
public class Jan27 {
    ...
    public static void main(String[] args) {
        ...
        int[] nums = {0, 1, 1, 1, 2, 2, 3, 3, 4};        //{0,1,2,3,4,_,_,_,_,_}
    ...
    public static int removeDuplicates(int[] nums) {
        ...
        int k = 1; // Initialize the length of the modified array
        ...
        for (int i = 1; i < nums.length; i++) {
            ...
            if (nums[i] != nums[i - 1]) {
                ...
                k++; // Increment the length of the modified array
            }
        }
